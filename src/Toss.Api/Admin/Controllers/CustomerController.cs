...
//using Toss.Api.Admin.Controllers;
...
//            return Ok(File(bytes, MimeTypes.TextXlsx, $"customerdata-{customer.Id}.xlsx"));
//        }
//        catch (Exception exc)
//        {
...
//            return Ok(File(bytes, MimeTypes.TextXlsx, "customers.xlsx"));
//        }
//        catch (Exception exc)
//        {
//            await _notificationService.ErrorNotificationAsync(exc);
...
//    [CheckPermission(StandardPermission.Customers.CUSTOMERS_VIEW)]
//    [CheckPermission(StandardPermission.Customers.CUSTOMERS_IMPORT_EXPORT)]
//    public virtual async Task<IActionResult> ExportXmlAll([FromBody] CustomerSearchModel model)
//    {
//        var customers = await _customerService.GetAllCustomersAsync(customerRoleIds: model.SelectedCustomerRoleIds.ToArray(),
//            email: model.SearchEmail,
//            username: model.SearchUsername,
...
//            return Ok(File(Encoding.UTF8.GetBytes(xml), "application/xml", "customers.xml"));
//        }
//        catch (Exception exc)
//        {
//            await _notificationService.ErrorNotificationAsync(exc);
