    ...
    : BaseAuditableEntity, IAggregateRoot
{
    ...
    public static Product CreateNew(int productTypeId, string name, string shortDescription, string fullDescription, bool visibleIndividually)
    {
        ...
        // Example: raise a domain event if needed
