using Catalog.Domain.AggregatesModel.Common;
using Catalog.Domain.AggregatesModel.Discounts;
using Catalog.Domain.AggregatesModel.Security;
...
/// </summary>
public class Manufacturer : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountManufacturerMapping>, ISoftDeletedEntity
{
    /// <summary>
