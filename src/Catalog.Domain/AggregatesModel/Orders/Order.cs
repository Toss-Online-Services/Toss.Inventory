...
using Catalog.Domain.AggregatesModel.Payments;
using Catalog.Domain.AggregatesModel.Shipping;
using Catalog.Domain.AggregatesModel.Tax;

namespace Catalog.Domain.AggregatesModel.Orders;
