        ...
        public virtual long Version
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(DateTime))
                    throw new InfrastructureDataException("One of the following properties must be initialized: either Version or DateTime");
        ...
        public virtual string Description
        {
            get
            {
                ...
                if (string.IsNullOrEmpty(NopVersion))
                    throw new InfrastructureDataException("One of the following properties must be initialized: either Description or NopVersion");
