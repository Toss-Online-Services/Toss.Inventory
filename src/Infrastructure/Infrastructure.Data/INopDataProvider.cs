...
public partial interface INopDataProvider
{
    ...
    /// </returns>
    Task<TEntity> InsertEntityAsync<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    TEntity InsertEntity<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    Task UpdateEntityAsync<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    /// <param name="entity">Entity with data to update</param>
    /// <typeparam name="TEntity">Entity type</typeparam>
    void UpdateEntity<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    /// <typeparam name="TEntity">Entity type</typeparam>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task UpdateEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : Entity;
    ...
    /// <param name="entities">Entities with data to update</param>
    /// <typeparam name="TEntity">Entity type</typeparam>
    void UpdateEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : Entity;
    ...
    /// <typeparam name="TEntity">Entity type</typeparam>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task DeleteEntityAsync<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    /// <param name="entity">Entity for delete operation</param>
    /// <typeparam name="TEntity">Entity type</typeparam>
    void DeleteEntity<TEntity>(TEntity entity) where TEntity : Entity;
    ...
    /// <typeparam name="TEntity">Entity type</typeparam>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task BulkDeleteEntitiesAsync<TEntity>(IList<TEntity> entities) where TEntity : Entity;
    ...
    /// <param name="entities">Entities for delete operation</param>
    /// <typeparam name="TEntity">Entity type</typeparam>
    void BulkDeleteEntities<TEntity>(IList<TEntity> entities) where TEntity : Entity;
    ...
    /// </returns>
    Task<int> BulkDeleteEntitiesAsync<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : Entity;
    ...
    /// </returns>
    int BulkDeleteEntities<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : Entity;
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : Entity;
    ...
    /// <typeparam name="TEntity">Entity type</typeparam>
    /// <param name="entities">Collection of Entities</param>
    void BulkInsertEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : Entity;
    ...
    IQueryable<TEntity> GetTable<TEntity>() where TEntity : Entity;
    ...
    /// </returns>
    Task<int?> GetTableIdentAsync<TEntity>() where TEntity : Entity;
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    Task SetTableIdentAsync<TEntity>(int ident) where TEntity : Entity;
    ...
    Task TruncateAsync<TEntity>(bool resetIdentity = false) where TEntity : Entity;
