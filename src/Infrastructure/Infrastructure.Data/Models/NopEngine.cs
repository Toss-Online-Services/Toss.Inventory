    ...
    public virtual object ResolveUnregistered(Type type)
    {
        ...
        foreach (var constructor in type.GetConstructors())
            try
            {
                ...
                {
                    var service = Resolve(parameter.ParameterType) ?? throw new InfrastructureDataException("Unknown dependency");
                    return service;
                });
        ...
        throw new InfrastructureDataException("No constructor was found that had all the dependencies satisfied.", innerException);
    }
