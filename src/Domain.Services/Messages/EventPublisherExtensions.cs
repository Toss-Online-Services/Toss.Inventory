...
public static class EventPublisherExtensions
{
    ...
    /// <returns>A task that represents the asynchronous operation</returns>
    public static async Task EntityTokensAddedAsync<T, U>(this IEventPublisher eventPublisher, T entity, IList<U> tokens) where T : BaseEntity
    {
    ...
    /// <param name="tokens">Tokens</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    public static async Task MessageTokensAddedAsync<U>(this IEventPublisher eventPublisher, MessageTemplate message, IList<U> tokens)
    {
