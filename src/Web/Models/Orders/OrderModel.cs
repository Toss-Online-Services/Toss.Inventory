...
public partial record OrderModel : BaseNopEntityModel
{
    ...
    public string OrderTotalDiscount { get; set; } = string.Empty;
    [NopResourceDisplayName("Admin.Orders.Fields.RedeemedRewardPoints")]
    public int RedeemedRewardPoints { get; set; }
    [NopResourceDisplayName("Admin.Orders.Fields.RedeemedRewardPoints")]
    public string RedeemedRewardPointsAmount { get; set; } = string.Empty;
    ...
    public string RefundedAmount { get; set; } = string.Empty;
    ...
    public string TaxRatesValue { get; set; } = string.Empty;
    ...
    public string PickupAddressGoogleMapsUrl { get; set; } = string.Empty;
    ...
    public string ShippingAddressGoogleMapsUrl { get; set; } = string.Empty;
    ...
    //checkout attributes
    public string CheckoutAttributeInfo { get; set; } = string.Empty;
    ...
    public string PrimaryStoreCurrencyCode { get; set; } = string.Empty;
...
public partial record OrderAggreratorModel : BaseNopModel
{
    ...
    public string AggregatorProfit { get; set; } = string.Empty;
    public string AggregatorShipping { get; set; } = string.Empty; 
    public string AggregatorTax { get; set; } = string.Empty;
    public string AggregatorTotal { get; set; } = string.Empty;
}
