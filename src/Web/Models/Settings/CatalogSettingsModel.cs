...
public partial record CatalogSettingsModel : BaseNopModel, ISettingsModel
{
    ...
    public CatalogSettingsModel()
    {
        ...
        AttributeValueOutOfStockDisplayTypes = new(Enumerable.Empty<int>());
        ProductUrlStructureTypes = new(Enumerable.Empty<int>());
    }
    ...
    public string DefaultViewMode { get; set; } = string.Empty;
    ...
    public string PageShareCode { get; set; } = string.Empty;
    ...
    [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.NewProductsPageSizeOptions")] public string NewProductsPageSizeOptions { get; set; } = string.Empty;
    ...
    [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.SearchPagePageSizeOptions")] public string SearchPagePageSizeOptions { get; set; } = string.Empty;
    ...
    [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ProductsByTagPageSizeOptions")] public string ProductsByTagPageSizeOptions { get; set; } = string.Empty;
