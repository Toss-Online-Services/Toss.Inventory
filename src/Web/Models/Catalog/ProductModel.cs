    ...
    IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
{
    ...
    [NopResourceDisplayName("Admin.Catalog.Products.Fields.AssociatedToProductName")]
    public string AssociatedToProductName { get; set; } = string.Empty;
    ...
    public string RequiredProductIds { get; set; } = string.Empty;
    ...
    [NopResourceDisplayName("Admin.Catalog.Products.Fields.StockQuantity")]
    public string StockQuantityStr { get; set; } = string.Empty;
    ...
    public string BaseDimensionIn { get; set; } = string.Empty;

    public string BaseWeightIn { get; set; } = string.Empty;
